...
import { 
  ...
  collection, addDoc, getDocs, query, where, orderBy, onSnapshot, doc, updateDoc, deleteDoc, getDocFromServer 
...
// Initialize Firestore with persistent local cache for instant loading
